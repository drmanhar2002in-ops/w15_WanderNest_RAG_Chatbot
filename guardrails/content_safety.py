...
class ContentSafety:
    ...
    def __init__(self):
        ...
        self.unsafe_patterns = {
            'violence': ['kill', 'attack', 'harm'],  # HINT: List of violence-related keywords like ['kill', 'attack', etc.]
            'hate_speech': ['hate', 'discriminate', 'harass'],  # HINT: List of hate speech keywords like
            'profanity': ['damn', 'hell', 'crap'],  # HINT: List of profanity keywords
            'personal_attack': ['stupid', 'idiot', 'moron']  # HINT: List of personal attack keywords like
        }
        
        # HINT: Define travel-specific red flags
        self.travel_red_flags = ['fraud', 'fake booking', 'scam']  # HINT: List like ['fraud', 'fake booking', 'scam', etc.]
            ...
            for keyword in keywords:
                if keyword in text_lower:  
                    flags.append({
                        'category': category,
                        'keyword': keyword,   
                        'severity': 'high' if category == 'violence' or category == 'hate_speech' else 'medium' if category == 'profanity' else 'low'  # HINT: 'high' for violence/hate speech, 'medium' for profanity, 'low' for personal attack
                    })
