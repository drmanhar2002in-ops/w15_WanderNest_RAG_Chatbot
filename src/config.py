...
class Config:
    ...
    AZURE_OPENAI_API_VERSION = os.getenv("AZURE_OPENAI_API_VERSION")  # HINT: "AZURE_OPENAI_API_VERSION"
    AZURE_OPENAI_DEPLOYMENT_NAME = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME")  # HINT: "AZURE_OPENAI_DEPLOYMENT_NAME"
    AZURE_OPENAI_EMBEDDING_DEPLOYMENT = os.getenv("AZURE_OPENAI_EMBEDDING_DEPLOYMENT")  # HINT: "AZURE_OPENAI_EMBEDDING_DEPLOYMENT"
